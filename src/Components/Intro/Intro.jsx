    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100  rounded-circle card" src={Prathvi1} alt="First slide"  style={{height:"550px"}}/>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 rounded-circle card" src={Prathvi2} alt="Second slide"  style={{height:"550px"}}/>
          </div>
